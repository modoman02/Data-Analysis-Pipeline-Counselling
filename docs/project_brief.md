...
**Owner:** Moritz (analyst) + ChatGPT (planning/analysis) + Codex in VS Code (implementation)

## Context
You are providing pro-bono data science/analytics consulting for a best friend who runs a small, local online marketing / video production agency.
He produces short- and mid-length videos for local businesses and also operates his own Instagram channel as a protagonist/brand.
